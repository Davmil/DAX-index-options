...
smile1 = callopt(strcmp(callopt.Expiry,'2008-01-18') & strcmp(callopt.Date,'2008-01-17'),[5 12]); % 1 day to Mat.
smile2 = callopt(strcmp(callopt.Expiry,'2008-02-15') & strcmp(callopt.Date,'2008-01-17'),[5 12]); % 1 month
smile3 = callopt(strcmp(callopt.Expiry,'2008-03-20') & strcmp(callopt.Date,'2008-01-17'),[5 12]); % 2 months
smile4 = callopt(strcmp(callopt.Expiry,'2008-06-20') & strcmp(callopt.Date,'2008-01-17'),[5 12]); % 6 months
smile5 = callopt(strcmp(callopt.Expiry,'2008-09-19') & strcmp(callopt.Date,'2008-01-17'),[5 12]); % 9 months
smile6 = callopt(strcmp(callopt.Expiry,'2008-12-19') & strcmp(callopt.Date,'2008-01-17'),[5 12]); % 12 months
...
smile1 = callopt(strcmp(callopt.Expiry,'2010-01-15') & strcmp(callopt.Date,'2010-01-14'),[5 12]); % 1 day to Mat.
smile2 = callopt(strcmp(callopt.Expiry,'2010-02-19') & strcmp(callopt.Date,'2010-01-14'),[5 12]); % 1 month
smile3 = callopt(strcmp(callopt.Expiry,'2010-03-19') & strcmp(callopt.Date,'2010-01-14'),[5 12]); % 2 months
smile4 = callopt(strcmp(callopt.Expiry,'2010-07-16') & strcmp(callopt.Date,'2010-01-14'),[5 12]); % 6 months
smile5 = callopt(strcmp(callopt.Expiry,'2010-09-17') & strcmp(callopt.Date,'2010-01-14'),[5 12]); % 9 months
smile6 = callopt(strcmp(callopt.Expiry,'2010-12-17') & strcmp(callopt.Date,'2010-01-14'),[5 12]); % 12 months
...
volsrf = callopt(strcmp(callopt.Date,'2008-01-17'),[5 9 12]); % Maturity, ImplVola
...
volsrf = callopt(strcmp(callopt.Date,'2010-01-15'),[5 9 12]); % Maturity, ImplVola
figure('position',[100 100 1200 800])
srfce = VolSurf2(volsrf.Time_to_Maturity, volsrf.Strike, volsrf.ImplVola);
...
volsrf = callopt(strcmp(callopt.Date,'2008-01-17'),[9 12]); % Maturity, ImplVola
...
volsrf = callopt(strcmp(callopt.Date,'2010-01-15'),[9 12]); % Maturity, ImplVola
...
volsrf = callopt(strcmp(callopt.Date,'2013-12-02'),[9 12]); % Maturity, ImplVola
